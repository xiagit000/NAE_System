...
<r:javascript name="/resources/js/enrollmentPlan/add.js"></r:javascript>
         ...
         <select name="classId">
          ...
          <tr><td><b>招生开始日期：</b><input name="beginTime"  onclick="WdatePicker()" placeholder="点击选择日期" readonly/>
         <b>招生截止日期：</b><input name="endTime"  onclick="WdatePicker()" placeholder="点击选择日期" readonly/></td></tr>
