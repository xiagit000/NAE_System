...
public class UserDaoImpl extends BaseDaoImpl<User, Long> implements UserDao {
	...
	public Integer getStudentCount() {
		String queryString = "select count(*) FROM User u WHERE u.userType=?1";
		return executeCountQuery(queryString, UserType.Student);
	}

	@Override
	public Integer getActiveStudentCount() {
		String queryString = "select count(*) FROM User u WHERE u.userType=?1 AND u.active=?2";
		return executeCountQuery(queryString, UserType.Student,true);
	}
