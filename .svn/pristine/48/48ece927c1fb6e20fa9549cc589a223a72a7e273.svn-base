		...
		<div class="wrapper">
			 <ul class="breadcrumb">
		         ...
		         <li><r:a href="/portal/navigation/${parent.id}/child/${child.id}/news">"${child.name}"的新闻列表</r:a> <span class="divider">/</span></li>
		          <li class="active">修改二级导航条目"${child.name}"的新闻</li>
          	</ul>
          	<form id="add_form" action="<c:url value='/portal/navigation/${parent.id}/child/${child.id}/news/${portalDefaultInformation.id}' />" method="POST">
