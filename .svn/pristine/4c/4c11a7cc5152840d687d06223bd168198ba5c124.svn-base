...
<r:layout title="评分标准">
	...
	<div class="wrapper">
		...
		<form id="add_form"
			action="<c:url value='/scoringStandard/${scoringStandard.id }' />"
			method="post">
			...
			<table class="table table-hover">
				<tbody>
					...
					<tr>
						...
						<td><input name="learnVideoProportion" id="learnVideoProportion"
							value="<fmt:formatNumber value='${scoringStandard.learnVideoProportion*100 }' type='number'/>" /></td>
					</tr>
					<tr>
						<th width="150px">研修论文比重：</th>
						<td><input name="learnThesisProportion" id="learnThesisProportion"
