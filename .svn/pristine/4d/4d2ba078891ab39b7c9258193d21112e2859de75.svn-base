...
<r:layout title="修改一级导航条目" >
<jsp:include page="../layout/administrator_navbar.jsp" />
		<div class="wrapper">
			 <ul class="breadcrumb">
	              <li><r:a href="/">首页</r:a> <span class="divider">/</span></li>
	              <li><r:a href="/portal/navigation">一级导航条列表</r:a> <span class="divider">/</span></li>
	              <li class="active">编辑一级导航条目</li>
          	</ul>
          	<form id="add_form" action="<c:url value='/portal/navigation/${navigation.id}' />" method="POST">
          	    ...
          	    <table class="table">
		         	<tbody>
		         		...
		         		<tr>
		         			<td colspan="2"><input name="name" value="${navigation.name}"/></td>
		         		</tr>
