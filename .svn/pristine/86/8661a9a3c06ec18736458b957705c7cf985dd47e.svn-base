...
public enum Privilege {
	...
	SYSTEM_ANNOUNCEMENT(UserType.System_Administrator),
	...
	SYSTEM_GRADE(UserType.System_Administrator),
	SYSTEM_GRADUATE(UserType.System_Administrator),
	SYSTEM_SCHRING_STANDARD(UserType.System_Administrator),
