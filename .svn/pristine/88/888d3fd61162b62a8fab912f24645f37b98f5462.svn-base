...
<r:layout title="学务信息管理" >
<jsp:include page="../../../layout/administrator_navbar.jsp" />
<div class="wrapper">
          <ul class="breadcrumb">
              <li><r:a href="/">首页</r:a> <span class="divider">/</span></li>
              <li class="active">学务信息管理</li>
          </ul>
     <r:a href="/portalinfo/backstage/studyinfo/create" class="button">添加学务信息</r:a>
		<br/>	<br/>
    <table class="table table-hover table-show" >
       ...
       <c:forEach items="${list}" var="portalDefaultInformation" varStatus="status"> 
	       <tr>
		       ...
		       <td>
		       		<r:a href="/portalinfo/backstage/studyinfo/${portalDefaultInformation.id}/update">编辑</r:a>
