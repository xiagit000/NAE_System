...
<div class="wrapper">
	<ul class="breadcrumb">
		...
		<li><r:a href="/learnthesis/show">结束提交的研修论文列表</r:a> <span class="divider">/</span></li>
		<li class="active">我批改的研修论文信息</li>
	</ul>
	<table class="table table-hover" >
		<c:if test="${empty learnThesisSubmitList}">您未修改任何研修论文！</c:if>
		...
		<c:forEach items="${learnThesisSubmitList}" var="learnThesisSubmit" varStatus="status">
			<tr>
				...
				<td>
					${learnThesisSubmit.score}(<fmt:message key="learnThesis_${learnThesisSubmit.learnThesisRating}" />)
				</td>
				<td> 
