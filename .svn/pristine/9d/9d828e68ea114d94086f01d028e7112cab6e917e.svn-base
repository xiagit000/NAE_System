...
public class SmallTopicController extends ApplicationController {
	...
	@RequiredPrivilege(value={Privilege.SYSTEM_SMALLTOPIC})
	@RequestMapping
	public String index(@PathVariable Long bsid,Model model,HttpServletRequest request,RedirectAttributes redirectAttr,Integer page){
