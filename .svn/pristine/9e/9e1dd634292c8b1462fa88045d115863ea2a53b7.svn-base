...
<r:layout title="校本研修管理 | 添加校本研修小课题">
<jsp:include page="../../layout/administrator_navbar.jsp" />
	<div class="wrapper">
	<ul class="breadcrumb">
		<li><r:a href="/">首页</r:a> <span class="divider">/</span></li>
		<li><r:a href="/bigsubject">校本研修大主题列表</r:a> <span class="divider">/</span></li>
		<li><r:a href="/bigsubject/${bigSubject.id}/smalltopic">大主题"${bigSubject.title}"的小课题列表</r:a> <span class="divider">/</span></li>
		<li>创建小课题</li>
	</ul>

	<form id="add_form" action="<c:url value='/bigsubject/${bigSubject.id}/smalltopic' />"
		method="post">
	...
	<table class="table">
		<tbody>
			...
			<tr>
				...
				<r:a href="/bigsubject/${bigSubject.id}/smalltopic" class="button">取消</r:a></td>
			</tr>
		</tbody>
	</table>
	</form>
