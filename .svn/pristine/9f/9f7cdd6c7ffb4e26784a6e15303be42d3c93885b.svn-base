...
<r:layout title="修改图文资讯" >
<jsp:include page="../../../layout/administrator_navbar.jsp" />
		<div class="wrapper">
			 <ul class="breadcrumb">
	              <li><r:a href="/">首页</r:a> <span class="divider">/</span></li>
	              <li><r:a href="/portalinfo/backstage/imagecontent">图文资讯列表</r:a> <span class="divider">/</span></li>
	              <li class="active">修改图文资讯</li>
          	</ul>
          	<form id="add_form" action="<c:url value='/portalinfo/backstage/imagecontent/${portalDefaultInformation.id}' />" method="POST"   enctype="multipart/form-data">
          		<table class="table">
		         	<tbody>
		         		<tr>
		         			<td><b>图文资讯标题</b></td>
		         		...
		         		<tr>
		         			<td><b>图文资讯内容(可以直接黏贴包含图片表格等元素的内容)</b></td>
		         	...
		         	<tr>
		         		<td colspan="2">
	        				...
	        				<r:a href="/portalinfo/backstage/imagecontent" class="button">取消</r:a>
		         		</td></tr>
		         	</tbody>
		         </table>
