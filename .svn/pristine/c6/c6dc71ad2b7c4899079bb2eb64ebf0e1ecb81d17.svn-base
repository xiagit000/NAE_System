...
<r:layout title="教学服务信息管理" >
<jsp:include page="../../../layout/administrator_navbar.jsp" />
<div class="wrapper">
          <ul class="breadcrumb">
              <li><r:a href="/">首页</r:a> <span class="divider">/</span></li>
              <li class="active">教学服务信息管理</li>
          </ul>
     <r:a href="/portalinfo/backstage/teachinfo/create" class="button">添加教学服务信息</r:a>
		<br/>
		<br/>
    <table class="table table-hover table-show" >
       ...
       <c:forEach items="${list}" var="portalDefaultInformation" varStatus="status"> 
	       <tr>
		       ...
		       <td>
		       		<r:a href="/portalinfo/backstage/teachinfo/${portalDefaultInformation.id}/update">编辑</r:a>
