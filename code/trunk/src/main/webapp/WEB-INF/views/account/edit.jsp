...
<jsp:include page="../layout/administrator_navbar.jsp" />
	<div class="wrapper">
         ...
         <td><b>性别：</b></td>
         <td><input type="radio" name="sex" value="男" ${account.sex=="男"?"checked=true":""}/>男
         &nbsp;&nbsp;
         ...
         <td><b>邮政编码：</b></td>
         <td><input name="zipCode" value="${account.zipCode }"/></td></tr>
         <tr><td><b>邮箱：</b></td>
         <td><input  name="email" value="${account.email }"/></td>
         <td><b>联系电话：</b></td>
         <td><input  name="tel" value="${account.tel }"/></td></tr>
         <tr><td><b>最高学位：</b></td>
         ...
         <tr><td><b>毕业院校：</b></td>
         <td><input  name="graduatedSchool" value="${account.graduatedSchool }"/></td>
         <td><b>毕业专业：</b></td>
         <td><input  name="graduatedSpecialty" value="${account.graduatedSpecialty }"/></td></tr>
         <tr><td><b>工作单位：</b></td>
         ...
         <td><b>工作职称：</b></td>
         <td><input  name="workTitles" value="${account.workTitles }"/></td></tr>
         <tr><td><b>工作年限：</b></td>
         <td><input  name="workYear" value="${account.workYear }"/></td>
         <td><b>工作简历：</b></td>
         <td><input  name="workDescription" value="${account.workDescription }"/></td></tr>
         <tr><td><b>培训和获奖信息：</b></td>
         <td colspan="3"><input  name="learnAndRewardInfo" value="${account.learnAndRewardInfo }"/></td></tr>
         <tr><td colspan="2"><b>备注：</b></td></tr>
         <tr>
         <td colspan="4"><textarea name="description" cols="170" rows="10" >${account.description }</textarea></td></tr>
         <tr>
         	<td colspan="4">
         		 <input class="button" type="submit" value="提交"/>
         		<r:a href="/account" class="button">取消</r:a>
         	</td>
         </tr>
         </tbody>
         </table>
