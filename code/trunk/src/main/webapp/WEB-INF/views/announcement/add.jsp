...
<r:layout title="公告添加" >
	...
	<form id="add_form" action="<c:url value='/announcement' />"
		method="post" enctype="multipart/form-data">
		<table class="table table-hover">
			<tbody>
				<tr>
					<td><b>公告主题：</b><input name="name"
						value="${announcement.name }" />*</td>
				</tr>
				<tr>
					<td><b>公告内容：</b>
					<textarea name="details">${announcement.details }</textarea></td>
				</tr>

				<tr>
					<td><b>添加附件：</b><input type="file" name="file" /></td>
				</tr>
			</tbody>
		</table>
