	...
	<form id="add_form" action="<c:url value='/learnspeacialty/${learnSpeacialty.id}' />" method="post">
		...
		<table class="table">
			<tbody>
				...
				<tr>
					<td colspan="2"><button type="submit" class="button">更新</button> <r:a href="/learnspeacialty" class="button">取消</r:a></td>
				</tr>
			</tbody>
		</table>
	</form>
