...
<r:layout title="培训项目 | 培训子项目 |编辑培训子项目">
...
<div class="wrapper">
	...
	<ul class="breadcrumb">
		...
		<li class="active">编辑培训子项目"${learnSubProject.name}"</li>
	</ul>

	<form id="add_form" action="<c:url value='/learnproject/${learnProject.id}/learnsubproject/${learnSubProject.id}' />"
		method="post">

	<input type="hidden" name="id" value="${learnSubProject.id}"/>
	<input type="hidden" name="_method" value="put"/>

	<table class="table">
		<tbody>
			<tr>
				<th colspan="2">选择培训学科</th>
			</tr>
			<tr>
				<td colspan="2"><select name="disciplineId">
