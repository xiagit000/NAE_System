...
<div class="wrapper">
	...
	<table class="table table-hover">
		<tbody>
			...
			<tr>
				<th  width="150" colspan="2">研修论文开始时间</th>
			</tr>
			<tr>
				<td width="150"><input type="text" name="beginTime" onclick="WdatePicker()"  readonly="readonly"
			...
			<tr>
				<th  width="150" colspan="2">研修论文结束时间</th>
			</tr>
			<tr>
				<td  width="150"><input type="text" name="submitTime" onclick="WdatePicker()" readonly="readonly"
			...
			<tr>
				<th  width="150" colspan="2">研修论文题干</th>
			</tr>
			<tr>
				<td  width="150"><input type="text" name="title"
