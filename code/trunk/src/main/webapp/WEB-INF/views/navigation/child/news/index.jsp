...
<div class="wrapper">
     ...
     <r:a href="/portal/navigation/${parent.id}/child/${child.id}/news/create" class="button">添加"${child.name}"的新闻</r:a>
		<br/>	<br/>
    <table class="table table-hover table-show" >
       ...
       <c:forEach items="${list}" var="portalDefaultInformation" varStatus="status"> 
	       <tr>
		       ...
		       <td>
		       		<r:a href="/portal/navigation/${parent.id}/child/${child.id}/news/${portalDefaultInformation.id}/update">编辑</r:a>
		       		<r:a href="/portal/navigation/${parent.id}/child/${child.id}/news/${portalDefaultInformation.id}"  data-method="delete" data-confirm="确定删除吗？" >删除</r:a>
		       </td>
		   </tr>
       </c:forEach>
       </tbody>
