...
<r:layout title="国培计划信息管理" >
<jsp:include page="../../../layout/administrator_navbar.jsp" />
<div class="wrapper">
          <ul class="breadcrumb">
              <li><r:a href="/">首页</r:a> <span class="divider">/</span></li>
              <li class="active">国培计划信息管理</li>
          </ul>
     <r:a href="/portalinfo/backstage/gp/create" class="button">添加国培计划新闻</r:a>
		<br/>	<br/>
    <table class="table table-hover table-show" >
       ...
       <c:forEach items="${list}" var="portalDefaultInformation" varStatus="status"> 
	       <tr>
		       ...
		       <td>
		       		<r:a href="/portalinfo/backstage/gp/${portalDefaultInformation.id}/update">编辑</r:a>
