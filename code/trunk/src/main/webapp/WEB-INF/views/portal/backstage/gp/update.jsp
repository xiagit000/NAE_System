...
<r:layout title="修改国培计划信息" >
<jsp:include page="../../../layout/administrator_navbar.jsp" />
		<div class="wrapper">
			 <ul class="breadcrumb">
	              <li><r:a href="/">首页</r:a> <span class="divider">/</span></li>
	              <li><r:a href="/portalinfo/backstage/gp">国培信息列表</r:a> <span class="divider">/</span></li>
	              <li class="active">修改国培计划信息</li>
          	</ul>
          	<form id="add_form" action="<c:url value='/portalinfo/backstage/gp/${portalDefaultInformation.id}' />" method="POST">
          		...
          		<table class="table">
		         	<tbody>
		         		...
		         		<tr>
		         			<td><b>国培计划内容(可以直接黏贴包含图片表格等元素的内容)</b></td>
		         	...
		         	<tr>
		         		<td colspan="2">
	        				...
	        				<r:a href="/portalinfo/backstage/gp" class="button">取消</r:a>
		         		</td></tr>
		         	</tbody>
		         </table>
