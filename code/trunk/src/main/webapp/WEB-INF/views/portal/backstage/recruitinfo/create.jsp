...
<r:layout title="添加招生服务信息" >
<jsp:include page="../../../layout/administrator_navbar.jsp" />
		<div class="wrapper">
			 <ul class="breadcrumb">
	              <li><r:a href="/">首页</r:a> <span class="divider">/</span></li>
	              <li><r:a href="/portalinfo/backstage/noticeinfo">招生服务信息列表</r:a> <span class="divider">/</span></li>
	              <li class="active">添加招生服务信息</li>
          	</ul>
          	<form id="add_form" action="<c:url value='/portalinfo/backstage/recruitinfo' />" method="POST">
          	    <table class="table">
		         	<tbody>
		         		<tr>
		         			<td><b>招生服务信息标题</b></td>
