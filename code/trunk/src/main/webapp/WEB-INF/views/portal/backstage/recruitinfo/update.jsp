...
<r:layout title="修改招生服务信息" >
<jsp:include page="../../../layout/administrator_navbar.jsp" />
		<div class="wrapper">
			 <ul class="breadcrumb">
	              <li><r:a href="/">首页</r:a> <span class="divider">/</span></li>
	              <li><r:a href="/portalinfo/backstage/recruitinfo">招生服务信息列表</r:a> <span class="divider">/</span></li>
	              <li class="active">修改招生服务信息</li>
          	</ul>
          	<form id="add_form" action="<c:url value='/portalinfo/backstage/recruitinfo/${portalDefaultInformation.id}' />" method="POST">
          		...
          		<table class="table">
		         	<tbody>
		         		...
		         		<tr>
		         			<td><b>招生服务信息内容(可以直接黏贴包含图片表格等元素的内容)</b></td>
		         	...
		         	<tr>
		         		<td colspan="2">
	        				...
	        				<r:a href="/portalinfo/backstage/recruitinfo" class="button">取消</r:a>
		         		</td></tr>
		         	</tbody>
		         </table>
