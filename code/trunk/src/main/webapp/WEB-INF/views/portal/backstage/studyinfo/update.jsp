...
<r:layout title="修学务信息" >
<jsp:include page="../../../layout/administrator_navbar.jsp" />
		<div class="wrapper">
			 <ul class="breadcrumb">
	              <li><r:a href="/">首页</r:a> <span class="divider">/</span></li>
	              <li><r:a href="/portalinfo/backstage/studyinfo">学务信息列表</r:a> <span class="divider">/</span></li>
	              <li class="active">修改学务信息</li>
          	</ul>
          	<form id="add_form" action="<c:url value='/portalinfo/backstage/studyinfo/${portalDefaultInformation.id}' />" method="POST">
          		...
          		<table class="table">
		         	<tbody>
		         		...
		         		<tr>
		         			<td><b>学务信息内容(可以直接黏贴包含图片表格等元素的内容)</b></td>
		         	...
		         	<tr>
		         		<td colspan="2">
	        				...
	        				<r:a href="/portalinfo/backstage/studyinfo" class="button">取消</r:a>
		         		</td></tr>
		         	</tbody>
		         </table>
