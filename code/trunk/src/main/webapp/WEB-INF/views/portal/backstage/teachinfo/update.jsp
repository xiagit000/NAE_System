...
<r:layout title="修改教学服务信息" >
<jsp:include page="../../../layout/administrator_navbar.jsp" />
		<div class="wrapper">
			 <ul class="breadcrumb">
	              <li><r:a href="/">首页</r:a> <span class="divider">/</span></li>
	              <li><r:a href="/portalinfo/backstage/teachinfo">教学服务信息列表</r:a> <span class="divider">/</span></li>
	              <li class="active">修改教学服务信息</li>
          	</ul>
          	<form id="add_form" action="<c:url value='/portalinfo/backstage/teachinfo/${portalDefaultInformation.id}' />" method="POST">
