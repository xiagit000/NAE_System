...
jQueryFormUtils.LANG =  {
    errorTitle : '表单提交失败',
    requiredFields : '请填写',
    badTime : '请填写正确的时间[hh:mm]',
    badEmail : '请输入正确的Email地址',
    badTelephone : 'You have not given a correct phone number',
    badSecurityAnswer : 'You have not given a correct answer to the security question',
    badDate : '请输入正确的日期[YYYY-MM-DD]',
    tooLongStart : '您填写的字符不能超过 ',
    tooLongEnd : '字符',
    tooShortStart : '您填写的字符不能少于 ',
    tooShortEnd : ' 字符',
    badLength : '您填写的内容必须在',
    notConfirmed : 'Values could not be confirmed',
    badDomain : '请填写正确的域名',
    badUrl : '请填写完整的URL地址',
    badFloat : '请填写正确的浮点型数字',
    badCustomVal : '请输入提示的字符',
    badInt : '请填写正确的整数',
    badSecurityNumber : '错误的安全码',
    badUKVatAnswer : 'Incorrect UK VAT Number',
    badNumberOfSelectedOptionsStart : '您最少要要选择 ',
    badNumberOfSelectedOptionsEnd : ' 项'
};
